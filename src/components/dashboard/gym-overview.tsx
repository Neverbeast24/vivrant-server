        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            <Link
              key={card.href}
              href={card.href}
              className="rounded-[1.4rem] border border-[#26222f]/8 bg-[#fdfbf4] p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#5f45e6]/25 hover:shadow-md"
            >
              ...
              <p className="mt-1 text-xs leading-5 text-[#847f8c]">{card.detail}</p>
            </Link>
          ))}
        </div>
      </Stagger>
      <Panel title="Quick start" className="mt-4" right={<Weight size={16} className="text-[#5f45e6]" />}>
        <p className="text-sm leading-6 text-[#6f6b79]">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <Link
            href="/dashboard/gym/sessions"
            className="inline-flex items-center rounded-full border border-[#26222f]/12 bg-white/70 px-5 py-3 text-xs font-black text-[#4c4757] transition hover:border-[#5f45e6]/30 hover:text-[#5f45e6]"
          >
            Log a session
          </Link>
        </div>
