  ...
  return (
    ...
    >
      <div className="mb-4 grid gap-3 sm:grid-cols-3">
        <div className="rounded-2xl border border-ink/8 bg-surface/50 p-4">
          <p className="text-[10px] font-black tracking-wider text-muted">LATEST WEIGHT</p>
        ...
        <div className="rounded-2xl border border-ink/8 bg-surface/50 p-4">
          <p className="text-[10px] font-black tracking-wider text-muted">CHANGE</p>
      ...
      {insight && (
        <div className="mb-4 rounded-2xl border border-accent/15 bg-accent-soft/60 p-4">
          <div className="flex items-center justify-between gap-3">
            <p className="text-sm font-black">{insight.title}</p>
            <span className="text-[10px] font-black text-accent">{insight.score}/100</span>
          </div>
          <p className="mt-2 text-sm leading-6 text-muted">{insight.body}</p>
          <p className="mt-3 text-xs font-bold text-muted">Trend: {insight.trend}</p>
          <p className="mt-1 text-xs font-black text-accent">Next: {insight.next_step}</p>
        </div>
      )}
