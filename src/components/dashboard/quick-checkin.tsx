  ...
  return (
    <>
      <motion.button
        ...
        className="focus-ring inline-flex items-center justify-center gap-2 self-start rounded-full bg-[#26222f] px-5 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-[#5f45e6]"
      >
            ...
            >
              <div className="mb-6 flex items-center justify-between">
                ...
                <button
                  ...
                  aria-label="Close"
                  onClick={() => setOpen(false)}
                  className="focus-ring grid size-9 place-items-center rounded-full bg-[#fdfbf4]/85 text-[#726d79] transition hover:bg-[#fdfbf4]"
                >
                  <X size={17} />
                </button>
              </div>
              ...
              <form action={formAction} className="space-y-4">
                    ...
                    {moods.map(([val, emoji]) => (
                      <button
                        ...
                        className={`focus-ring flex-1 rounded-2xl border py-3 text-xl transition ${
                          mood === val
                            ? "border-[#5f45e6]/40 bg-[#fdfbf4] shadow-sm"
                            : "border-black/5 bg-[#fdfbf4]/65 hover:bg-[#fdfbf4]"
                        }`}
                      >
                        {emoji}
                      </button>
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-2xl border border-black/7 bg-[#fdfbf4]/85 px-4 py-3 text-sm outline-none transition focus:border-[#5f45e6]/40 focus:ring-4 focus:ring-[#5f45e6]/8"
                  />
                </label>
                ...
                <button
                  disabled={pending}
                  className="focus-ring flex w-full items-center justify-center gap-2 rounded-2xl bg-[#26222f] px-5 py-3.5 text-sm font-black text-white shadow-lg transition hover:bg-[#5f45e6] disabled:opacity-60"
                >
                  {pending ? (
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full rounded-2xl border border-black/7 bg-[#fdfbf4]/85 px-3 py-2.5 text-sm outline-none transition focus:border-[#5f45e6]/40 focus:ring-4 focus:ring-[#5f45e6]/8"
      />
    </label>
  );
}
