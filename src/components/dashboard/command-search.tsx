...
const dashboardDestinations = [
  ...
  { label: "Log workout", detail: "Today’s program, checkboxes, and rest timer — or a walk", href: "/dashboard/movement/log", icon: Dumbbell, keywords: "log workout movement program session rest" },
  ...
  { label: "Gym sessions", detail: "Run today’s program with checkboxes and rest timers", href: "/dashboard/gym/sessions", icon: Weight, keywords: "session log history gym program rest timer" },
