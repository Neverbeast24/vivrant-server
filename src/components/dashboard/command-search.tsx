...
const dashboardDestinations = [
  ...
  { label: "Gym program", detail: "Pick training days and create an AI plan", href: "/dashboard/gym/plans", icon: Weight, keywords: "plan program ai gym schedule days monday sunday" },
